...
const Jewellery = () => {
	return (
		<div className='px-1 text-gray-700 lg:mt-12'>
			{/* top */}
			<div className='flex justify-start md:justify-end md:text-5xl text-4xl font-bold py-4 '>
			...
			<div className='flex flex-col md:flex-row justify-between py-4 mt-2 gap-5'>
				...
				{/* right */}
				<div className='flex flex-col lg:flex-row basis-1/2 mt-12'>
